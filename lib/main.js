...
async function run() {
    ...
    const octokit = new Octokit({
        ...
        userAgent: "github-to-omnifocus/1.2.0",
        baseUrl: c.github.api_url,
        // log: console,
    })

    console.log("Ensuring github-to-omnifocus tags exist...")
    await omnifocus.ensureTagExists(c.omnifocus.tag)
    await omnifocus.ensureTagExists(c.omnifocus.issue_tag)
    await omnifocus.ensureTagExists(c.omnifocus.pr_tag)
    ...
    try {
        ...
        await addNewIssues(c.omnifocus.issue_project,
            c.omnifocus.tag,
            c.omnifocus.issue_tag,
            tasks,
            issues)
