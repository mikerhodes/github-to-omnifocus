...
async function run() {
    ...
    await processNotifications(octokit, c)
    await processAssignedItems(octokit, c)
    await processReviewItems(octokit, c)
}
 ...
 */
async function processNotifications(octokit, c) {
    try {
 ...
 * @param {configuration.Config} c
 */
async function processAssignedItems(octokit, c) {
 ...
 * @param {configuration.Config} c
 */
async function processReviewItems(octokit, c) {
