...
exports.loadConfig = () => {
    ...
    console.log(`  Omnifocus tag: ${c.omnifocus.app_tag} `)
    console.log(`  Omnifocus issue project: ${c.omnifocus.assigned_project} `)
    console.log(`  Omnifocus PRs project: ${c.omnifocus.review_project} `)
    console.log(`  Omnifocus notifications project: ${c.omnifocus.notification_project} `)
